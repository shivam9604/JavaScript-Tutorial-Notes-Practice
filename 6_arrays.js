...
// console.log(fruits);
// fruits.push("litchi")
// console.log(fruits.push("guava"));      // The push() method returns the new length (i.e 7).
// console.log(fruits);


//~ 2: pop(): Method that removes the last element from an array.
// console.log(fruits.pop());      // The pop() method return delete value (i.e banana)
// console.log(fruits);
...
//? splice() method: The splice() method of Array instances changes the contents of an array by removing or replacing existing elements and/or adding new elements in place
...
//^ syntax:
        ...
        // indexOf(searchElement, startFromIndex);

// const numbers = [1, 2, 3, 4, 6, 5, 6, 7, 8, 9];
// console.log(numbers.indexOf(3));        //Output: 2
// console.log(numbers.indexOf(3, 5));     //Output: -1
...
// const result3 = numbers.lastIndexOf(6, 5);
// console.log(result3);                       // Output: 3 (search backward)
// const result4 = numbers.indexOf(6, 5);
...
//^ syntax: 
        /* 
        array.find((currentElement, index, array) => {
            // write logic here
        });
        */
...
// console.log(result);        // Output: 7 (value)
...
//   return curElem > 15;
// });
// console.log(result2);       // Output: 3 (index number)
...
//! Example 1: le'ts say user wants to delete value 6.
// let value = 6;
// const numbers = [1, 2, 3, 4, 6, 5, 6, 7, 8, 9];
...
//     // console.log(curElem.price <= 500);   //(give boolean value)
...
// const numbers = [84,65,11,45,82,10,45, 7, 4, 8, 9];
// numbers.sort();
// console.log(numbers);   //with large number it not work, it will not sort the array 
...
// const numbers = [1, 2, 4, 3, 6, 5, 6, 7, 4, 8, 9];
// const numbers = [84,65,11,45,82,10,41,7,4,8,9];
...
// const names = ["ram", "shivam", "laxman"];
// const prefixName = names.map((curName) => `Mr. ${curName}`);
// console.log(prefixName);

//? Reduce method:-
/* The reduce method in JavaScript we used to accumulate or reduce an array to a single value. 
