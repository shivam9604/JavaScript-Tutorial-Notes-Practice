...
//   console.log("Watch TV at home");
// } else {
//   console.log("Be at home and sleep");
// }
...
//     }
//     else{
//       console.log("You are not eligible to vote, because you are not registered");
//     }
//   }
//   else{
...
// }
// else{
//       console.log("You are not eligible to vote, because you are Younger");
// }
...
/*//! Write a JavaScript switch statement that takes a variable areaOfShapes representing different shapes, 
    and based on its value, calculates and logs the area of the corresponding shape. 
    Consider three shapes: 'Rectangle,' 'Circle,' and 'Square.' 
    For 'Rectangle,' use variables a and b as the sides; 
    for 'Circle,' use a variable r as the radius; and 
    for 'Square,' use variable a as the side length. 
    If the provided shape is not recognized, log a message saying, 'Sorry the shape is not available.' 
    Test your switch statement with areaOfShapes set to 'Square' and sides a and b set to 5 and 10, respectively. 
    Ensure that the correct area (25 in this case) is logged to the console.
*/
...
//   default:
//     console.log("Sorry! the shape not Matches");
//     break;
// }
...
//! practice 🧑‍💻
//? let's create a table of 5   (in this format 5*1 = 5)
...
// let sum = 0
// debugger;    //~show each step how its work
// for(let i = 1; i <= 10; i++){
//   sum = sum + i;
// }
// console.log(sum);
...
//! Write program to print table for given number (8,12,25) using for Loop?
