...
//? providing a way to group related data and functions together. 
...
//     // console.log(`A car Brand is ${this.brand} and model is ${this.model} is ready to Start Engine.`);
//     console.log(`A car Brand is ${car.brand} and model is ${car.model} is ready to Start Engine.`);
//   },
// };
// car.start();
...
// let obj = { id: 5, name: "Shivam Gupta" };
// let obj1 = {};
...
// const obj1 = { name: "shivam" };
// const obj2 = { name: "shivam" };
// const obj3 = obj1;
...
//   name: "Shivam Gupta",
//   greet: () => {
//     console.log(this);    // in fat arrow function, here 'this' refers to the global object
//   },
// };
...
//   // if (obj1.length != obj2.length) {   //length property is not used in Object. so, here it will not work
//   //   return false;
//   // }
...
//   // for (const key of obj1) {   //ERROR: here we can't use for-of loop also because object is not iterable
//   //   console.log(obj1[key]);
//   // }

//   // in place of that we use for-in loop
...
// // // Example usage:
// let objA = { name: "Arya", age: 26, city: "New York" };
// // let objB = { name: "Arya", age: 26, city: "New York", country: "USA" };
// let objB = { name: "Arya", age: 26, city: "New York" };
