...
//~ lets make a reusable code (by using Function)
...
// function greet() {
//   console.log("Hello Buddy, Welcome to JavaScript ");
// }
...
/*Q.  Write a JavaScript program that defines a function called greet to welcome individuals to JavaScript. 
      The function should take a name parameter and output the message "Hello [name], Welcome to JavaScript". 
      Call the function twice, once with the argument "Shivam" and once with the argument "Ram".
*/

// function greet(name) {    //here, 'name' is the parameter
//   console.log("Hello " + name + ", Welcome to JavaScript Language.");
// }

// // Calling the function
// greet("Ram");   //here, 'Ram' is the argument
// greet("Sita");  //here, 'Sita' is the argument
...
//   //   console.log(a + b);
//   return a + b;
//   // console.log("hello I am function");     //it will not run because, after the return keyword compiler do not read any line of statement  
// }
...
// console.log(calculator(5, 2, "+")); // Output: 7
// console.log(calculator(18, 4, "-")); // Output: 14
// console.log(calculator(10, 6, "*")); // Output: 60
