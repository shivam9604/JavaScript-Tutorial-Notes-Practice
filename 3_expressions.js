...
// examples
// var myFavNum = 15;      //Assigns the value 15 to the variable myFavNum

// var courseName = 'Learning Javascript';
...
//! What will be the Output 🤔💭    var result = "hello" / 2 ❓
// var result = "hello" / 2;
...
// console.log(2 < 12 < 5);                //output: true  (2<12:- true(1), true<5 (i.e 1<5) which true)
