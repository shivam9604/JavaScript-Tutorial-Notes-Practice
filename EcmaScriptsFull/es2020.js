...
// console.log(maxNumber);         //Output: 9007199254740991 (max safe integer value used in JS)

// console.log(maxNumber + 10);    //Output: 9007199254741000 (Wrong Value (i.e ERROR Value))

// maxNumber = BigInt(maxNumber);  
// console.log(maxNumber + 10n);               //Output: 9007199254741001n (Correct Value Obtained by using bigint)

//* =======================================
//*  Nullish Coalescing Operator ??
//* ======================================
//? In JavaScript, the nullish coalescing operator (??) is a logical operator that provides a concise way to handle nullish (null or undefined) values. 
