...
//   console.log(name);
// }
// // console.log(name);      //error: 'name' is not able to access outside the scope  
...
//   return a + b;
// }
// console.log(sum());         //output: 30 (here, we are not passing any argument, it take from the default Parameter (i.e a=20, b=10))
...
// //OR (in more concise way)

// let sub = (a, b) => console.log(`The sum of ${a} and ${b} is ${a - b}.`);
// sub(15, 5);
...
// const greet = () => console.log("Hello welcome to javascript.");
// greet();
...
// console.log(sum(1, 2, 3, 4, 5));   //Output: 10 
...
// console.log(sum(1, 2, 3, 4, 5));    //Output: 12
