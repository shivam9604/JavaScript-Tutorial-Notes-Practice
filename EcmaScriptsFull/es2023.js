...
const myNames = ["shivam", "kumar", "gupta", "codefix"];
...
// //? Array.prototype.toSpliced(start, deleteCount, ...items);
// const splicedArr = myNames.toSpliced(1, 1, "guptaTechnical");
// console.log("original", myNames);
...
const replaceWith = myNames.with(2, "guptaTechnical");
console.log("original", myNames);
